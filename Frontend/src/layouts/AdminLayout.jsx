...
import { Grid, Database, Shield, Sparkles, Users, LogOut, Globe } from 'lucide-react';
...
const AdminLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/admin-dashboard/policy', label: 'Policy & Limits', icon: Shield },
            ...
            <aside className="w-64 bg-[#1a2327] border-r border-[#263238] flex flex-col z-20">
                <div className="p-6 flex items-center gap-3 border-b border-[#263238]">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-emerald-500 font-medium">State HQ Portal</p>
                    </div>
                </div>
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="h-16 bg-[#1a2327] border-b border-[#263238] flex items-center justify-between px-8 z-10 shrink-0">
                    <h1 className="text-lg font-semibold text-white">
                        {navItems.find(item => item.path === location.pathname)?.label || 'Super Admin Dashboard'}
                    </h1>
