...
const UserManagement = () => {
    ...
    const handleChange = (e) => {
        ...
        setFormData((prev) => {
            ...
            // Auto reset entity_id if switching back to 'ro'
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="max-w-2xl bg-[#1a2327] border border-[#263238] rounded-xl p-6 shadow-sm">
                <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                    <Users className="w-5 h-5 text-emerald-500" /> Onboard New User
                </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Regional Office Dropdown - Always visible for 'ro' and 'industry' */}
                    <div>
                        <label className="block text-sm font-medium text-slate-300 mb-1">Assign to Regional Office</label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    {/* Industry Dropdown - Only visible if role === 'industry' */}
                    {formData.role === 'industry' && (
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-1">Assign to Industry</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    required={formData.role === 'industry'}
                                    disabled={loadingData}
                                    className="w-full pl-10 pr-10 py-2 bg-[#0b1114] border border-[#263238] rounded-lg text-white focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors appearance-none disabled:opacity-50"
                                >
                                    <option value="" disabled>
